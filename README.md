# penguin-game-fixes
A collection of fixes to make native Linux games work.

## Motivation
Many games have a native Linux build, however sometimes it doesn't even start. This can happen for many reasons, but often it's due to silly issues that affect some users but not others.
